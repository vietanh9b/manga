  ...
  <tbody>
    ...
    if(isset($load_truyen_cungloai)){
        foreach ($load_truyen_cungloai as $key) {
            ...
            <td>'.$key['ten_tl'].'</td>
            <td>'.$key['trangthai'].'</td>
            <td><button type="button" value="'.$key['id_truyen'].'" name="fix-btn" class="btn btn-primary"><a class="text-light" href="index.php?act=them_sp&type=2&product='.$key['id_truyen'].'">Sửa</a></button></td>
